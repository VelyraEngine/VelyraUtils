...
TEST_F(TestVlEnum, MyColorsToString) {
    ...
    EXPECT_EQ(toString(COLOR_GREEN), "COLOR_GREEN");
    EXPECT_EQ(toString(COLOR_BLUE), "COLOR_BLUE");
    EXPECT_EQ(toString(COLOR_YELLOW), "COLOR_YELLOW");
    EXPECT_EQ(toString(COLOR_MAX_VALUE), "COLOR_MAX_VALUE");
}

TEST_F(TestVlEnum, MyColorsFromString) {
    EXPECT_EQ(fromString<COLOR>("COLOR_UNKNOWN"), COLOR_UNKNOWN);
    EXPECT_EQ(fromString<COLOR>("COLOR_RED"), COLOR_RED);
    EXPECT_EQ(fromString<COLOR>("COLOR_GREEN"), COLOR_GREEN);
    EXPECT_EQ(fromString<COLOR>("COLOR_BLUE"), COLOR_BLUE);
    EXPECT_EQ(fromString<COLOR>("COLOR_YELLOW"), COLOR_YELLOW);
    EXPECT_EQ(fromString<COLOR>("COLOR_NOT_EXIST"), COLOR_MAX_VALUE);
}
...
TEST_F(TestVlEnum, MyShapesToString) {
    EXPECT_EQ(toString(SHAPE_UNKNOWN), "SHAPE_UNKNOWN");
    EXPECT_EQ(toString(SHAPE_CIRCLE), "SHAPE_CIRCLE");
    EXPECT_EQ(toString(SHAPE_SQUARE), "SHAPE_SQUARE");
    EXPECT_EQ(toString(SHAPE_TRIANGLE), "SHAPE_TRIANGLE");
    EXPECT_EQ(toString(SHAPE_MAX_VALUE), "SHAPE_MAX_VALUE");
}

TEST_F(TestVlEnum, MyShapesFromString) {
    EXPECT_EQ(fromString<SHAPE>("SHAPE_UNKNOWN"), SHAPE_UNKNOWN);
    EXPECT_EQ(fromString<SHAPE>("SHAPE_CIRCLE"), SHAPE_CIRCLE);
    EXPECT_EQ(fromString<SHAPE>("SHAPE_SQUARE"), SHAPE_SQUARE);
    EXPECT_EQ(fromString<SHAPE>("SHAPE_TRIANGLE"), SHAPE_TRIANGLE);
    EXPECT_EQ(fromString<SHAPE>("SHAPE_NOT_EXIST"), SHAPE_MAX_VALUE);
}
